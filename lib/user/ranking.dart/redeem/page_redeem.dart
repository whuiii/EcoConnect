                    ...
                    builder: (context, snapshot) {
                      ...
                      return FutureBuilder<QuerySnapshot>(
                        future: FirebaseFirestore.instance
                            ...
                            .get(),
                        builder: (context, userVoucherSnapshot) {
                          if (!userVoucherSnapshot.hasData) {
                            return const Center(
                                child: CircularProgressIndicator());
                          }

                          final redeemedVoucherIds = userVoucherSnapshot
                              .data!.docs
                              .map((doc) => doc['voucherId'])
                              .toSet();
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final voucherPoint = data['point'] ?? 0;
                              ...
                              final isRedeemed =
                                  redeemedVoucherIds.contains(docId);
